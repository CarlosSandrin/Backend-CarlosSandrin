...
export class ProductManager {
  constructor() {
    if (!fs.existsSync("./PrimerPreEntrega-CarlosSandrin/products.json")) {
      fs.writeFileSync(
        "./PrimerPreEntrega-CarlosSandrin/products.json",
        "[]",
        "utf-8"
      );
    }
    this.products = [];
    this.path = "./PrimerPreEntrega-CarlosSandrin/products.json";
