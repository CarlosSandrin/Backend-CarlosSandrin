...
export class CartManager {
  constructor() {
    if (!fs.existsSync("./PrimerPreEntrega-CarlosSandrin/carts.json")) {
      fs.writeFileSync("./PrimerPreEntrega-CarlosSandrin/carts.json", "[]", "utf-8");
    }
    this.carts = [];
    this.path = "./PrimerPreEntrega-CarlosSandrin/carts.json";
